...
sl = nc.Dataset('/projects/hfm/sbidadi/nrel_phase_vi/nrel_phase_vi_output/ti_calculations/u_7/sst/sampling_line00000.nc', parallel=True, comm=MPI.COMM_WORLD, info=MPI.Info())
