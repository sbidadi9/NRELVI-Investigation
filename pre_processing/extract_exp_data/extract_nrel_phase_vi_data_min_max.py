...
with open('cth_avg_u_7.txt', 'w') as f:
     ...
     f.write('%f %f %f %f\n' %(np.amin(cth30_data_u_7), np.amin(cth47_data_u_7), np.amin(cth63_data_u_7), np.amin(cth80_data_u_7)))
     f.write('%f %f %f %f\n' %(np.amax(cth30_data_u_7), np.amax(cth47_data_u_7), np.amax(cth63_data_u_7), np.amax(cth80_data_u_7)))

with open('cth_avg_u_12.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(cth_avg_u_12_list[0], cth_avg_u_12_list[1], cth_avg_u_12_list[2], cth_avg_u_12_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(cth30_data_u_12), np.amin(cth47_data_u_12), np.amin(cth63_data_u_12), np.amin(cth80_data_u_12)))
     f.write('%f %f %f %f\n' %(np.amax(cth30_data_u_12), np.amax(cth47_data_u_12), np.amax(cth63_data_u_12), np.amax(cth80_data_u_12)))

with open('cth_avg_u_15.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(cth_avg_u_15_list[0], cth_avg_u_15_list[1], cth_avg_u_15_list[2], cth_avg_u_15_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(cth30_data_u_15), np.amin(cth47_data_u_15), np.amin(cth63_data_u_15), np.amin(cth80_data_u_15)))
     f.write('%f %f %f %f\n' %(np.amax(cth30_data_u_15), np.amax(cth47_data_u_15), np.amax(cth63_data_u_15), np.amax(cth80_data_u_15)))

with open('cth_avg_u_20.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(cth_avg_u_20_list[0], cth_avg_u_20_list[1], cth_avg_u_20_list[2], cth_avg_u_20_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(cth30_data_u_20), np.amin(cth47_data_u_20), np.amin(cth63_data_u_20), np.amin(cth80_data_u_20)))
     f.write('%f %f %f %f\n' %(np.amax(cth30_data_u_20), np.amax(cth47_data_u_20), np.amax(cth63_data_u_20), np.amax(cth80_data_u_20)))
...
with open('ctq_avg_u_7.txt', 'w') as f:
     ...
     f.write('%f %f %f %f\n' %(np.amin(ctq30_data_u_7), np.amin(ctq47_data_u_7), np.amin(ctq63_data_u_7), np.amin(ctq80_data_u_7)))
     f.write('%f %f %f %f\n' %(np.amax(ctq30_data_u_7), np.amax(ctq47_data_u_7), np.amax(ctq63_data_u_7), np.amax(ctq80_data_u_7)))

with open('ctq_avg_u_12.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(ctq_avg_u_12_list[0], ctq_avg_u_12_list[1], ctq_avg_u_12_list[2], ctq_avg_u_12_list[3]))  
     f.write('%f %f %f %f\n' %(np.amin(ctq30_data_u_12), np.amin(ctq47_data_u_12), np.amin(ctq63_data_u_12), np.amin(ctq80_data_u_12)))
     f.write('%f %f %f %f\n' %(np.amax(ctq30_data_u_12), np.amax(ctq47_data_u_12), np.amax(ctq63_data_u_12), np.amax(ctq80_data_u_12)))

with open('ctq_avg_u_15.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(ctq_avg_u_15_list[0], ctq_avg_u_15_list[1], ctq_avg_u_15_list[2], ctq_avg_u_15_list[3]))  
     f.write('%f %f %f %f\n' %(np.amin(ctq30_data_u_15), np.amin(ctq47_data_u_15), np.amin(ctq63_data_u_15), np.amin(ctq80_data_u_15)))
     f.write('%f %f %f %f\n' %(np.amax(ctq30_data_u_15), np.amax(ctq47_data_u_15), np.amax(ctq63_data_u_15), np.amax(ctq80_data_u_15)))

with open('ctq_avg_u_20.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(ctq_avg_u_20_list[0], ctq_avg_u_20_list[1], ctq_avg_u_20_list[2], ctq_avg_u_20_list[3]))  
     f.write('%f %f %f %f\n' %(np.amin(ctq30_data_u_20), np.amin(ctq47_data_u_20), np.amin(ctq63_data_u_20), np.amin(ctq80_data_u_20)))
     f.write('%f %f %f %f\n' %(np.amax(ctq30_data_u_20), np.amax(ctq47_data_u_20), np.amax(ctq63_data_u_20), np.amax(ctq80_data_u_20)))
...
with open('cn_avg_u_7.txt', 'w') as f:
     ...
     f.write('%f %f %f %f\n' %(np.amin(cn30_data_u_7), np.amin(cn47_data_u_7), np.amin(cn63_data_u_7), np.amin(cn80_data_u_7)))
     f.write('%f %f %f %f\n' %(np.amax(cn30_data_u_7), np.amax(cn47_data_u_7), np.amax(cn63_data_u_7), np.amax(cn80_data_u_7)))

with open('cn_avg_u_12.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(cn_avg_u_12_list[0], cn_avg_u_12_list[1], cn_avg_u_12_list[2], cn_avg_u_12_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(cn30_data_u_12), np.amin(cn47_data_u_12), np.amin(cn63_data_u_12), np.amin(cn80_data_u_12)))
     f.write('%f %f %f %f\n' %(np.amax(cn30_data_u_12), np.amax(cn47_data_u_12), np.amax(cn63_data_u_12), np.amax(cn80_data_u_12)))

with open('cn_avg_u_15.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(cn_avg_u_15_list[0], cn_avg_u_15_list[1], cn_avg_u_15_list[2], cn_avg_u_15_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(cn30_data_u_15), np.amin(cn47_data_u_15), np.amin(cn63_data_u_15), np.amin(cn80_data_u_15)))
     f.write('%f %f %f %f\n' %(np.amax(cn30_data_u_15), np.amax(cn47_data_u_15), np.amax(cn63_data_u_15), np.amax(cn80_data_u_15)))

with open('cn_avg_u_20.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(cn_avg_u_20_list[0], cn_avg_u_20_list[1], cn_avg_u_20_list[2], cn_avg_u_20_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(cn30_data_u_20), np.amin(cn47_data_u_20), np.amin(cn63_data_u_20), np.amin(cn80_data_u_20)))
     f.write('%f %f %f %f\n' %(np.amax(cn30_data_u_20), np.amax(cn47_data_u_20), np.amax(cn63_data_u_20), np.amax(cn80_data_u_20)))
...
with open('ct_avg_u_7.txt', 'w') as f:
     ...
     f.write('%f %f %f %f\n' %(np.amin(ct30_data_u_7), np.amin(ct47_data_u_7), np.amin(ct63_data_u_7), np.amin(ct80_data_u_7)))
     f.write('%f %f %f %f\n' %(np.amax(ct30_data_u_7), np.amax(ct47_data_u_7), np.amax(ct63_data_u_7), np.amax(ct80_data_u_7)))

with open('ct_avg_u_12.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(ct_avg_u_12_list[0], ct_avg_u_12_list[1], ct_avg_u_12_list[2], ct_avg_u_12_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(ct30_data_u_12), np.amin(ct47_data_u_12), np.amin(ct63_data_u_12), np.amin(ct80_data_u_12)))
     f.write('%f %f %f %f\n' %(np.amax(ct30_data_u_12), np.amax(ct47_data_u_12), np.amax(ct63_data_u_12), np.amax(ct80_data_u_12)))

with open('ct_avg_u_15.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(ct_avg_u_15_list[0], ct_avg_u_15_list[1], ct_avg_u_15_list[2], ct_avg_u_15_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(ct30_data_u_15), np.amin(ct47_data_u_15), np.amin(ct63_data_u_15), np.amin(ct80_data_u_15)))
     f.write('%f %f %f %f\n' %(np.amax(ct30_data_u_15), np.amax(ct47_data_u_15), np.amax(ct63_data_u_15), np.amax(ct80_data_u_15)))

with open('ct_avg_u_20.txt', 'w') as f:
     f.write('%f %f %f %f\n' %(ct_avg_u_20_list[0], ct_avg_u_20_list[1], ct_avg_u_20_list[2], ct_avg_u_20_list[3]))
     f.write('%f %f %f %f\n' %(np.amin(ct30_data_u_20), np.amin(ct47_data_u_20), np.amin(ct63_data_u_20), np.amin(ct80_data_u_20)))
     f.write('%f %f %f %f\n' %(np.amax(ct30_data_u_20), np.amax(ct47_data_u_20), np.amax(ct63_data_u_20), np.amax(ct80_data_u_20)))
